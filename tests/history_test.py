...
def test_add_get_word_first_time():
    ...
    word1 = Word("人間", "にんげん", "human", "A human being.",
                 ["その子、人間じゃないの。ロボットなのよ。アンドロイド。"])
    word2 = Word("愛", "あい", "love", "The feeling of love.",
...
def test_add_get_word_already_stored():
    hist = History(**history_config)
    context1 = "その子、人間じゃないの。ロボットなのよ。アンドロイド。"
    context2 = "人間、そっくりね。ロボットの手まで、暖いわよ。"
    word1 = Word("人間", "にんげん", "human", "A human being.", [context1])
    word2 = Word("人間", "にんげん", "human", "A human being.", [context2])
    hist.add_word(word1)
    hist.add_word(word2)
